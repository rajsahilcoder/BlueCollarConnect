...
def recommend_cooks(address, specialty):
    ...
    if user_location != None:
        ...
        print(str(df["Specialty"]) + " ||" + str(encoded_location))
...
def main(address, specialty):
    ...
    recommended_cooks = recommended_cooks.drop_duplicates(subset='Name', keep=False)
    return recommended_cooks.head(10).to_dict(orient="records")


recommended_cooks = main(address, specialty)

print(recommended_cooks)
# print(type(recommended_cooks))
# for cks in recommend_cooks:
#     print(cks)
#     type(cks)
